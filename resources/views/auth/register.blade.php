                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('register.custom') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" placeholder="Nazwa użytkownika" id="name" class="form-control" name="name"
                            ...
                            <div class="form-group mb-3">
                                <input type="text" placeholder="E-mail" id="email_address" class="form-control"
                                    name="email" autocomplete="off" required autofocus>
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group mb-3">
                                <input type="password" placeholder="Hasło" id="password" class="form-control"
